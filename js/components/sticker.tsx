...
const StickerPeel: React.FC<StickerPeelProps> = ({
    ...
    return (
        <div className={`absolute transform-gpu cursor-grab active:cursor-grabbing ${className}`} ref={dragTargetRef} style={cssVars}>
            <style
            ...
            <svg width="0" height="0">
                <defs>
                    ...
                    <filter id="dropShadow">
                        <feDropShadow dx="0" dy="0" stdDeviation={3 * shadowIntensity} floodColor="white" floodOpacity={shadowIntensity} />
                    </filter>
            ...
            >
                <div className="sticker-main" style={stickerMainStyle}>
                    <div style={{ filter: 'url(#pointLight)' }}>
                        {imageComponent ? (
                            <div className="" style={imageStyle} onContextMenu={(e) => e.preventDefault()}>
                                {imageComponent}
                            </div>
                        ) : (
                            <img src={imageSrc} alt="" className="" style={imageStyle} draggable="false" onContextMenu={(e) => e.preventDefault()} />
                        )}
                    </div>
                </div>

                {/* <div className="absolute top-4 left-2 h-full w-full opacity-40" style={{ filter: 'brightness(0) blur(0px)' }}>
                    <div className="sticker-flap" style={flapStyle}>
                        {imageComponent ? (
                            <div className="" style={flapStyle} onContextMenu={(e) => e.preventDefault()}>
                                {imageComponent}
                            </div>
                        ) : (
                            <img src={imageSrc} alt="" className="" style={imageStyle} draggable="false" onContextMenu={(e) => e.preventDefault()} />
                ...
                <div className="sticker-flap absolute left-0 h-full w-full" style={flapStyle}>
